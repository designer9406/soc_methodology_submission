...
exec_time = (double)( T_end.tv_sec - T_start.tv_sec ) + ((double)( T_end.tv_usec - T_start.tv_usec ) / 1000000);
printf("GEMM Exec time  (hwacha):  %f s\n", exec_time);
}
